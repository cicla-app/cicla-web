      ...
      return (
        <div>
          ...
          <div>
            ...
            {stagesData[getCurrentStage(date, this.state.period)].health.resume4}
            </div>
            <div className="card">
              <ul>
                {stagesData[getCurrentStage(date, this.state.period)].health.tips.map((tip, i) => (
                  <li key={i}>
...
export default withAuthConsumer(Health);